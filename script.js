...
// 1. FUNGSI SIMPAN & UPLOAD (Payload Tanpa Status)
...
function renderTable(data, startIndex = 0) {
    ...
    body.innerHTML = data.map((i, index) => {
        ...
        <tr>
            ...
            <td class="text-center"><a href="${i.dpp}" target="_blank" class="btn btn-sm btn-outline-info ${i.dpp ? '' : 'disabled'}">View</a></td>
